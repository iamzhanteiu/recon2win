...
def test_phase_number_known_stage():
    assert console.phase_number("subdomain") == "[01/14]"
    assert console.phase_number("dnsx") == "[02/14]"
    assert console.phase_number("nuclei_dynamic") == "[13/14]"
...
def test_phase_number_zero_pads():
    console.set_enabled(True)
    assert console.phase_number("arjun").startswith("[12/")
